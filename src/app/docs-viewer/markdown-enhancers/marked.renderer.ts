...
const markedStringRenderer: any = {
...
const markedHtmlRenderer: Renderer<DocumentFragment, Node | string> = {
...
export const markedExtensionHtmlRnderer: MarkedExtension<DocumentFragment, Node | string> = {
  async: false,
  breaks: false,
  gfm: true,
  pedantic: false,
